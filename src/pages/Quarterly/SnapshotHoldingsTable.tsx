...
export default function SnapshotHoldingsTable({ holdings, snapshotId, loading, snap }: Props) {
  ...
  const accountColumns: ColumnsType<QuarterlyHoldingSnapshot> = [
    ...
    { title: "持仓数量", dataIndex: "shares", key: "shares", width: 100, align: "right", render: (v: number) => v.toLocaleString() },
    { title: "均价", dataIndex: "avg_cost", key: "avg_cost", width: 100, align: "right", render: (v: number) => v.toLocaleString("en-US", { minimumFractionDigits: 3, maximumFractionDigits: 3 }) },
    ...
    { title: "仓位", dataIndex: "weight", key: "weight", width: 90, align: "right", render: (v: number) => `${v.toFixed(2)}%` },
